...
class Interpreter implements Expr.Visitor<Object>,
  ...
  public Object visitSetExpr(Expr.Set expr) {
    ...
    if (!(object instanceof LoxInstance)) {
      throw new RuntimeError(expr.name, "Only instances of classes can have fields.");
    }
  ...
  public Object visitVariableExpr(Expr.Variable expr) {
    ...
    if (value == uninitialized) {
      throw new RuntimeError(expr.name, "Trying to use uninitialized variable.");
    }
  ...
  public Void visitClassStmt(Stmt.Class stmt) {
    ...
    if (superclass != null) {
      ...
      if (!(superclass instanceof LoxClass)) {
        throw new RuntimeError(stmt.superclass.name, "Superclass must be a class type.");
      }
    }
  ...
  public Object visitCallExpr(Expr.Call expr) {
    ...
    if (!(callee instanceof LoxCallable)) {
      throw new RuntimeError(expr.paren, "Not a callable.");
    }
